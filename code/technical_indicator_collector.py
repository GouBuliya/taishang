...
OKX_API_KEY = os.getenv("OKX_API_KEY", "YOUR_DEFAULT_API_KEY_OR_NONE")
OKX_SECRET_KEY = os.getenv("OKX_SECRET_KEY", "YOUR_DEFAULT_SECRET_OR_NONE")
OKX_PASS_PHRASE = os.getenv("OKX_PASS_PHRASE", "YOUR_DEFAULT_PASSPHRASE_OR_NONE")
...
# --- 代理配置 ---
HTTP_PROXY = os.getenv("HTTP_PROXY", "http://127.0.0.1:1080")
HTTPS_PROXY = os.getenv("HTTPS_PROXY", "http://127.0.0.1:1080")
...
# --- 最终输出结果 ---
try:
    print(json.dumps(all_periods_data, indent=2, ensure_ascii=False))
except Exception as e:
