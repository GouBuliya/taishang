      ...
      "detailed_analysis_and_reasoning": {
        ...
        "properties": {
          "low_level_reflection": {
            ...
            "properties": {
              ...
              "chart_pattern_analysis": { "type": "string", "description": "Must be in Simplified Chinese." }
            },
       ...
       "execution_details": {
        ...
        "items": {
          ...
          "required": [ "side", "posSide", "price","size","position_action",],
          "description": "execution_details 是执行细节信息，type 是交易类型，price 是价格,market 是是否启用市价单，如果你判断现在适合立刻下单，则market为true，否则为false,position_action 是持仓操作:加仓 减仓，平仓，持仓,开仓，"
        },
        "required": ["close"],
      },
      "data_info": {
